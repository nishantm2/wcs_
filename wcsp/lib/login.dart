...
class _LoginPageState extends State<LoginPage> {
        ...
        body: new Stack(
          ...
          children: <Widget>[
            ...
            new Column(
              ...
              children: <Widget>[
                new Image(
                  image: new AssetImage("assets/wcs.jpg"),
                  width: 120,
                  height: 120,
                ),
                new Form(
  ...
  signIn(custID, pass) async {
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    var jsonResponse;
    var data;
    var response = await http.post(
        "http://wcshcst.xyz/checkLoginPerson.php?id=${custID}&pass=${pass}");
    if (response.statusCode == 200) {
      ...
      if (jsonResponse != null) {
        ...
        if (jsonResponse['result'].isNotEmpty) {
          ...
          if (data[0]['Test'] == "1") {
            sharedPreferences.setString("custID", custID);
            flag = 1;
